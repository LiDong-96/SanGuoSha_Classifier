...
###### 1.主忠反的耐久。耐久我能想到的包括三个方面：本身血厚或可以回血（兀突骨、董卓、华雄、周泰、华佗等），可以吸收或者反弹伤害（嵇康、小乔、大乔、曹叡、老诸葛、卧龙诸葛、曹节、董允等），可以卖血为己方获取收益（郭嘉、荀彧、曹丕、戏志才等），技能本身带来的低嘲讽（如伏皇后、邓艾、钟会、孙策、秦宓、蔡文姬）。我选几个标将根据耐打程度来试打分：刘备3，关羽1，张飞1，赵云3，孙权2，周瑜2，孙尚香3，郭嘉4，夏侯惇4，曹操3。
